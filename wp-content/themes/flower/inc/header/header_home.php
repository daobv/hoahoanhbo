				...
				<div class="header">
					<div class="container clearfix">
						...
						<div class="mod-search">
							<form class="clearfix" action="<?php echo esc_url( home_url( '/' ) );?>" id="searchform" method="get" role="search">
								<div>
									<label for="s" class="screen-reader-text">Sản phẩm</label>
									<!-- <span class="vi"></span> -->
									<input class="s-text" type="text" value="Nhập từ khóa tìm kiếm" id="s" name="s" onblur="if (this.value=='') this.value = 'Nhập từ khóa tìm kiếm'" 
    onfocus="if (this.value=='Nhập từ khóa tìm kiếm') this.value = ''"  >
									<input class="s-submit"  type="submit" value="Tìm kiếm" id="searchsubmit">
